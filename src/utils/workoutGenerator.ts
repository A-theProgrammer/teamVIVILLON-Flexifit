...
function getCompoundExerciseForFocus(
  ...
  if (experience === 'beginner') {
    selectedExercise.sets = Math.max(2, selectedExercise.sets - 1);
    selectedExercise.reps = Math.min(15, selectedExercise.reps + 4);
    selectedExercise.intensity = 'Medium-Low';
  } else if (experience === 'advanced') {
    selectedExercise.sets = Math.min(5, selectedExercise.sets + 1);
